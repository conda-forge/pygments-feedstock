...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5682&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pygments-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pygments` can be installed with `conda`:
...
```
mamba install pygments
```

It is possible to list all of the versions of `pygments` available on your platform with `conda`:
...
```
mamba search pygments --channel conda-forge
```
...
mamba repoquery search pygments --channel conda-forge

# List packages depending on `pygments`:
mamba repoquery whoneeds pygments --channel conda-forge

# List dependencies of `pygments`:
mamba repoquery depends pygments --channel conda-forge
```
...
If you would like to improve the pygments recipe or build a new
...
Note that all branches in the conda-forge/pygments-feedstock are
